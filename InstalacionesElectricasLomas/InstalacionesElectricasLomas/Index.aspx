...
<body class="landing">
	<div id="page-wrapper">
		...
		<!-- Header -->
			<header id="header" class="altMenu">
				<nav id="nav">
					<ul>
                  ...
                  <div class="col-md-8 col-md-offset-2 wp1 animated fadeInLeft">
                    <h2>A Creative Portfolio Template</h2>
                      <p class="arrow">
                          &nbsp;</p>
                      <p class="arrow">
                          <img class="auto-style1" src="images/h1-bg.png" /></p>
                    <p>&nbsp;</p>
                  ...
                  <div class="col-md-12">
                    <h4 class="arrow">&nbsp;</h4>
                      ...
                      <p class="arrow">
                          ...
                          <img class="auto-style1" src="images/h1-bg.png" /></i></p>
                      <p class="arrow">&nbsp;</p>
                    <div class="features-wrapper">
                      <div class="col-md-4 wp2 animated fadeInUp">
                        <h2>
                            <img alt="" class="auto-style2" src="images/iphone-bg.png" /></h2>
                      ...
                      <div class="col-md-4 wp2 delay-05s animated fadeInUp">
                        ...
                        <h2>
                            <img alt="" class="auto-style3" src="images/keyboard-bg.jpg" /></h2>
                      ...
                      <div class="col-md-4 wp2 delay-1s animated fadeInUp">
                        ...
                        <h2>
                            <img alt="" class="auto-style4" src="images/l1.jpg" /></h2>
            ...
            <div class="row">
              <div class="col-md-12">
                <h1 class="arrow">We're a team that adore what we do</h1>
                  <p class="arrow">
                              <img alt="" class="auto-style1" src="images/h1-bg.png" /></p>
              </div>
            </div>
            <div class="row">
